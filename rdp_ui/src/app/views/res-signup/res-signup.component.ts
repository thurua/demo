...
export class ResSignupComponent implements OnInit, AfterContentChecked {
  ...
  `;
    ...
    public newResSignUp(valid: boolean, form: any) {
        if (this.isExist) {
        ...
        this.pro.saveLead(obj).subscribe((rsp: any) => {
            if (rsp.callstatus == "success") {
                ...
                let param = '/residential/thankyou/' + factSheet + '/' + salesAgreement + '/' + webReferenceNo;
        ...
        this.pro.getPackage().subscribe((rsp: any) => {
            if (rsp.callstatus == "success") {
                ...
                this.act.params.subscribe((params: Params) => {
                    let parPlanName = params["planName"];

                    if (parPlanName == "signupefix") {
                        this.showPlanName = this.vmPackage.eFixName;
                        this.vm.planName = this.vmPackage.eFixSfid;
                    }
                    else if (parPlanName == "signupesave") {
                        this.showPlanName = this.vmPackage.eSaveName;
                        this.vm.planName = this.vmPackage.eSaveSfid;
                    }
                    else if (parPlanName == "signupeq") {

                        this.showPlanName = this.vmPackage.eQPlusName;
                        this.vm.planName = this.vmPackage.eQPlusSfid;
                    }
                    else if (parPlanName == "signup") {
                        this.showPlanName = this.vmPackage.eSaveName;
                        this.vm.planName = '';
                    } else {
