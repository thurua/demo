...
@Entity
@Table(name = "portal_role_function__c", schema = "salesforce")
public class PortalRoleFunction {

	// region -- Fields --

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "portal_role_function__c_id_seq_generator")
	@SequenceGenerator(name = "portal_role_function__c_id_seq_generator", sequenceName = "salesforce.portal_role_function__c_id_seq", allocationSize = 1)
	...
	@Column(columnDefinition = "varchar(18)", name = "function_id__c")
