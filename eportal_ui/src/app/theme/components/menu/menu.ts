...
export const verticalMenuItems = [
    ...
    new Menu(70, 'Funding', null, null, 'money', null, true, 0),
    new Menu(80, 'Fund Request', '/pages/fund-request', null, 'crosshairs', null, false, 70),
    new Menu(90, 'Fund Availalbility', '/pages/fund-availability', null, 'suitcase', null, false, 70),
    new Menu(100, 'Help', '/pages/blank', null, 'chain', null, false, 0),
